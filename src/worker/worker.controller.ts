...
export class WorkerController {
  ...
  @ApiQuery({ name: 'dateFrom', required: false, example: '2025-08-01T00:00:00Z' })
  @ApiQuery({ name: 'dateTo', required: false, example: '2025-08-31T23:59:59Z' })
  @ApiQuery({ name: 'sortBy', required: false, example: 'date', enum: ['date','workerCount','salaryPerOne','totalSalary'] })
