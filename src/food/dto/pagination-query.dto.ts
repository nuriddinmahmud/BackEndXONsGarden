...
export class PaginationDto {
  ...
  @ApiPropertyOptional({
    example: 'date',
    description: 'date | amount | shopName | comment | createdAt',
  })
  @IsOptional() @IsString()
  sortBy?: 'date' | 'amount' | 'shopName' | 'comment' | 'createdAt';
  ...
  @ApiPropertyOptional({ example: 'korzinka' })
  @IsOptional() @IsString()
  search?: string;

  @ApiPropertyOptional({ example: 'Korzinka Supermarket' })
  @IsOptional() @IsString()
  shopName?: string;
