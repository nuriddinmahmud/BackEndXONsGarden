...
@Module({
  imports: [AuthModule, DrainageModule, EnergyModule, FertilizerModule, FoodModule, OilModule, RemontModule, TaxModule, TransportModule, WorkerModule, PrismaModule, ConfigModule],
